	    ...
	    value: function handleKeys(isFighting) {
	      ...
	      key("left", function () {
	        if (round.secondNum > 0) {
	          ...
	          //if one side is out of characters, i need to "end the fight"
	          //and just have them drifting harmlessly to the center.
	          if (round.container1.characters.length === 0) {
	            var firstNumIsEmpty = true;
	            round.container2.animateJoin(firstNumIsEmpty);
	          } else {
	...
	var Container = function () {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function animateJoin(firstNumIsEmpty) {
	      ...
	      var requestID = window.requestAnimFrame(this.animateJoin.bind(this));
	      if (this.frameCount === 10) {
	        this.frameCount = 0;
