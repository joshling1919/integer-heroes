...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadedImages = 0;
	var imageArray = new Array("./lib/images/ironman_right", "./lib/images/ironman_left");
	...
	var Integer = function () {
	  ...
	  _createClass(Integer, [{
	    ...
	    value: function shrinkAndGrow() {
	      ...
	      this.ctx.clearRect(this.xPos - 50, this.yPos - 90, 100, 115);
	...
	var Container = function () {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function animateFight() {
	      ...
	      if (this.containerNumber === 1) {
	        if (this.frameCount === 115) {
	          this.frameCount = 0;
	          window.cancelAnimationFrame(requestID);
	        } else {
	          this.frameCount += 1;
	          debugger;
	          this.ctx.clearRect(0, 300, 900, 150);
	          this.characters.forEach(function (character, index) {
	      ...
	      if (container.containerNumber === 1) {
	        ...
	        (function () {
	          ...
	          _this3.image.onload = function () {
	            _this3.ctx.drawImage(_this3.image, iron11.x, iron11.y, iron11.w, iron11.h, _this3.xPos, _this3.yPos, _this3.width, _this3.height);
	          };
