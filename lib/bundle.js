	...
	var Integer = function () {
	  ...
	  _createClass(Integer, [{
	    ...
	    value: function shrinkAndGrow() {
	      ...
	      this.ctx.clearRect(this.xPos - 60, this.yPos - 100, 120, 125);
	...
	var Round = function () {
	  ...
	  _createClass(Round, [{
	    ...
	    value: function startRound() {
	      ...
	      var directions = document.getElementById('modal-button');
	    ...
	    key: 'understoodButton',
	    value: function understoodButton(text) {
	      var _this = this;
	
	      var understood = document.getElementById('understood');
	      understood.onclick = function () {
	        _this.instructions.innerHTML = text;
	        _this.instructions.style.color = "black";
	        _this.instructions.style.background = "#31CBE3";
	      };
	    }
	  }, {
	    key: 'checkAnswer',
	    value: function checkAnswer(container, event) {
	      ...
	      if (correct) {
	        ...
	        this.instructions.innerHTML = "Hm, not quite! Remember, positive = superheroes; negative = villain. <button id='understood'>Got it!</button>";
	    ...
	    value: function displayInstructions(instructions) {
	      var _this2 = this;
	      ...
	      window.setTimeout(function () {
	        ...
	        document.onkeydown = _this2.handleEnter.bind(_this2);
	      }, 1200);
	    }
	  }, {
	    ...
	    value: function handleRight() {
	      ...
	      if (this.secondNum < 0) {
	        ...
	        window.setTimeout(function () {
	          if (_this3.container1.characters.length === 0) {
	            var firstNumIsEmpty = true;
	            _this3.container2.animateJoin(firstNumIsEmpty);
	          } else {
	            if (_this3.isFighting) {
	              _this3.container1.animateFight();
	              _this3.container2.animateFight();
	            } else {
	              _this3.container2.animateJoin();
	            }
	          }
	        }, 300);
	      }
	    ...
	    value: function handleLeft() {
	      ...
	      if (this.secondNum > 0) {
	        ...
	        window.setTimeout(function () {
	          if (_this4.container1.characters.length === 0) {
	            var firstNumIsEmpty = true;
	            _this4.container2.animateJoin(firstNumIsEmpty);
	          } else {
	            if (_this4.isFighting) {
	              _this4.container1.animateFight();
	              _this4.container2.animateFight();
	            } else {
	              _this4.container2.animateJoin();
	            }
	          }
	        }, 300);
	      }
	    ...
	    value: function conclusion() {
	      ...
	      var leftOver = this.calculateLeftOver();
	      var absLeftOver = Math.abs(leftOver);
	      var characterType = void 0;
	      var verb = "is";
	      if (leftOver !== 0) {
	        if (leftOver === -1) {
	    ...
	    key: 'calculateLeftOver',
	    value: function calculateLeftOver() {
	      var container1Length = this.container1.characters.length;
	      var container2Length = this.container2.characters.length;
	      var container1Value = void 0,
	          container2Value = void 0;
	    ...
	    key: 'wrongAnswerColors',
	    value: function wrongAnswerColors() {
	    ...
	    key: 'congratulate',
	    value: function congratulate() {
	      var randomInt = Math.round(Math.random() * (4 - 0));
	      var arrayOfCompliments = ["You're a rockstar!", "Way to go!", "You got it!", "Sweet!!", "Awesome!"];
	...
	var NumberLine = function () {
	  ...
	  _createClass(NumberLine, [{
	    ...
	    value: function start(secondNum) {
	      ...
	      this.ctx.drawImage(window.imageObjArray[18], 1050, 880, 200, 100);
	      this.ctx.drawImage(window.imageObjArray[19], 700, 880, 200, 100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Explosion = function () {
	  function Explosion(ctx) {
	    ...
	    this.ctx = ctx;
	    this.image = window.imageObjArray[4];
	    this.frame = 0;
	    this.width = 100;
	    this.height = 100;
	    this.xPos = 940;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Thor = function (_Character) {
	  ...
	  function Thor(value, ctx, xPos, yPos, container1, container2) {
	    ...
	    _this.ctx = ctx;
	    _this.imageRight = window.imageObjArray[5];
	    _this.imageLeft = window.imageObjArray[6];
	    _this.width = 105;
	    _this.height = 185;
	    _this.value = value;
	    return _this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Juggernaut = function (_Character) {
	  ...
	  function Juggernaut(value, ctx, xPos, yPos, container1, container2) {
	    ...
	    _this.ctx = ctx;
	    _this.imageRight = window.imageObjArray[7];
	    _this.imageLeft = window.imageObjArray[8];
	    _this.width = 105;
	    _this.height = 185;
	    _this.value = value;
	    return _this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hulk = function (_Character) {
	  ...
	  function Hulk(value, ctx, xPos, yPos, container1, container2) {
	    ...
	    _this.ctx = ctx;
	    _this.imageRight = window.imageObjArray[9];
	    _this.imageLeft = window.imageObjArray[10];
	    _this.width = 105;
	    _this.height = 170;
	    _this.value = value;
	    return _this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loki = function (_Character) {
	  ...
	  function Loki(value, ctx, xPos, yPos, container1, container2) {
	    ...
	    _this.ctx = ctx;
	    _this.imageRight = window.imageObjArray[11];
	    _this.imageLeft = window.imageObjArray[12];
	    _this.width = 105;
	    _this.height = 185;
	    _this.value = value;
	    return _this;
