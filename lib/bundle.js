...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _math_problem = __webpack_require__(7);
	...
	var Round = function () {
	  ...
	  _createClass(Round, [{
	    ...
	    value: function startRound() {
	      ...
	      this.buttons = new _buttons2.default(this.ctx, this.submitAnswer.bind(this), this.clearCharacters.bind(this), this.startRound.bind(this));
	    ...
	    value: function firstStage() {
	      ...
	      var firstContainerCount = 0;
	      var characters = void 0;
	      if (this.firstNum > 0) {
	        characters = [new _ironman2.default(), new _thor2.default(), new _hulk2.default()];
	      } else {
	        characters = [new _loki2.default(), new _juggernaut2.default(), new _goblin2.default()];
	      }
	      setTimeout(function () {
	        _this.automate(firstContainerCount, characters);
	      }, 1200);
	    }
	  }, {
	    key: 'automate',
	    value: function automate(firstContainerCount, characters) {
	      var _this2 = this;
	      ...
	      firstContainerCount++;
	      setTimeout(function () {
	        if (firstContainerCount !== Math.abs(_this2.firstNum)) {
	          _this2.automate(firstContainerCount, characters);
	        } else {
	          _this2.submitAnswer();
	        }
	      }, 700);
	    ...
	    key: 'automateNumberLine',
	    value: function automateNumberLine() {
	      var move = void 0;
	      if (this.firstNum < 0) {
	    ...
	    key: 'moveNumberLine',
	    value: function moveNumberLine(move, i) {
	      var _this3 = this;
	
	      setTimeout(function () {
	        move();
	        i += 1;
	        if (Math.abs(_this3.firstNum) !== i) {
	          _this3.moveNumberLine(move, i);
	        } else {
	          setTimeout(function () {
	            _this3.submitAnswer();
	          }, 900);
	    ...
	    key: 'secondContainerHelpText',
	    value: function secondContainerHelpText() {
	      var _this4 = this;
	
	      setTimeout(function () {
	        _this4.ctx.font = "50px Georgia";
	        _this4.ctx.fillText("Click on the correct", 1520, 260);
	        _this4.ctx.fillText("correct amount of", 1500, 320);
	        _this4.ctx.fillText("superheroes or villains", 1550, 380);
	        _this4.ctx.fillText('to represent ' + _this4.secondNum + '!', 1480, 440);
	        _this4.ctx.fillStyle = "green";
	        _this4.ctx.fillText("Hero = Positive 1", 1500, 520);
	        _this4.ctx.fillStyle = "red";
	        _this4.ctx.fillText("Villain = Negative 1", 1520, 580);
	      }, 700);
	    }
	  }, {
	    key: 'fourthStage',
	    value: function fourthStage() {
	      ...
	      setTimeout(function () {
	        if (_this5.firstNum * _this5.secondNum < 0) {
	          _this5.fightingStage();
	        } else {
	          _this5.joiningStage();
	        }
	      }, 1000);
	    ...
	    value: function finalStage(isFighting) {
	      ...
	      setTimeout(function () {
	        _this6.ctx.drawImage(window.imageObj['right_arrow'], 1050, 880, 200, 100);
	        _this6.ctx.drawImage(window.imageObj['left_arrow'], 700, 880, 200, 100);
	        _this6.handleKeys(isFighting);
	      }, 1500);
	    }
	  }, {
	    key: 'handleKeys',
	    ...
	    value: function handleArrowClicks(event) {
	      ...
	      var cursorX = (0, _click_util.getCursorXPos)(event, rect);
	      var cursorY = (0, _click_util.getCursorYPos)(event, rect);
...
/***/ (function(module, exports) {
	...
	var getCursorXPos = exports.getCursorXPos = function getCursorXPos(event, rect) {
	  var x = (event.clientX - rect.left) / (rect.right - rect.left) * event.currentTarget.width;
	  return x;
	};
	
	var getCursorYPos = exports.getCursorYPos = function getCursorYPos(event, rect) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ironmanJSON = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _explosionJSON = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _goblinJSON = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _thorJSON = __webpack_require__(17);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _juggernautJSON = __webpack_require__(19);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _hulkJSON = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lokiJSON = __webpack_require__(23);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Buttons = function () {
	  function Buttons(ctx, submitAnswer, clearCharacters, startRound) {
	  ...
	  _createClass(Buttons, [{
	    key: 'activate',
	    value: function activate(numButtons) {
	    ...
	    value: function handleButtonClick(event) {
	      ...
	      if (this.numButtons === 2) {
	        if (cursorX > 860 && cursorX < 1135 && cursorY > 350 && cursorY < 450) {
	          this.submit();
	        } else if (cursorX > 860 && cursorX < 1135 && cursorY > 530 && cursorY < 630) {
	          this.clearCharacters();
	        }
	      } else if (this.numButtons === 1) {
	        if (cursorX > 860 && cursorX < 1135 && cursorY > 880 && cursorY < 980) {
	          this.deactivate();
	          this.startRound();
	        }
	      }
