...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ironman_character = __webpack_require__(10);
	
	var _ironman_character2 = _interopRequireDefault(_ironman_character);
	...
	var Round = function () {
	  function Round(ctx) {
	    ...
	    this.container1 = new _container2.default(ctx, true, 1);
	    this.container2 = new _container2.default(ctx, false, 2);
	    this.ironmanStart = new _ironman_character2.default(ctx, 0, 0, this.container1, this.container2);
	...
	var Character = function () {
	  ...
	  _createClass(Character, [{
	    ...
	    value: function handleClick(event) {
	      var iron = _ironman_character2.default;
	      ...
	      if (cursorX > this.xPos && cursorX < this.xPos + this.width && cursorY > this.yPos && cursorY < this.yPos + this.height) {
	        if (!this.index) {
	          var newCharacter = this.newCharacter();
	    ...
	    key: 'newCharacter',
	    value: function newCharacter() {
	      var newCharacter = void 0;
	      if (this.constructor.name === "Ironman") {
	        newCharacter = new _ironman_character2.default(this.ctx, undefined, undefined, this.container1, this.container2);
	      }
	      return newCharacter;
	    }
	  }, {
...
/***/ function(module, exports) {
	...
	var Container = function () {
	  function Container(ctx, selected, containerNumber) {
	  ...
	  _createClass(Container, [{
	    ...
	    key: "deleteCharacter",
	    value: function deleteCharacter(characterIndex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ironman = function (_Character) {
	  ...
	  function Ironman(ctx, xPos, yPos, container1, container2) {
	    var _ref;
	  ...
	  _createClass(Ironman, [{
	    ...
	    value: function draw() {
	      ...
	      var iron = _ironman.IRONMAN0.frame;
