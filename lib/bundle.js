...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadedImages = 0;
	var imageArray = new Array("./lib/images/ironman_right.png", "./lib/images/ironman_left.png", "./lib/images/goblin_right.png", "./lib/images/goblin_left.png", "./lib/images/explosion.png", "./lib/images/thor_right.png", "./lib/images/thor_left.png");
	var imageObjArray = [];
	...
	var Round = function () {
	  ...
	  _createClass(Round, [{
	    ...
	    value: function startRound() {
	      ...
	      this.thorStart = new _thor2.default(1, this.ctx, 200, 0, this.container1, this.container2);
	      this.thorStart.draw();
	    ...
	    value: function handleKeys(isFighting) {
	      ...
	      key("right", function () {
	        if (round.secondNum < 0) {
	          ...
	          console.log(round.container1.characters.length);
	    ...
	    value: function animateJoin(firstNumIsEmpty) {
	      ...
	      if (this.frameCount === 10) {
	        ...
	        if (firstNumIsEmpty) {
	          ...
	          this.ctx.clearRect(800, 450, 2000, 200);
	        }
	        this.characters.forEach(function (character, index) {
