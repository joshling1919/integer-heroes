...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadedImages = 0;
	var imageArray = new Array("./lib/images/ironman_right.png", "./lib/images/ironman_left.png", "./lib/images/goblin_right.png", "./lib/images/goblin_left.png", "./lib/images/explosion.png", "./lib/images/thor_right.png", "./lib/images/thor_left.png", "./lib/images/juggernaut_right.png", "./lib/images/juggernaut_left.png", "./lib/images/hulk_right.png", "./lib/images/hulk_left.png");
	var imageObjArray = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thor = __webpack_require__(17);
	
	var _thor2 = _interopRequireDefault(_thor);
	
	var _juggernaut = __webpack_require__(19);
	
	var _juggernaut2 = _interopRequireDefault(_juggernaut);
	
	var _hulk = __webpack_require__(21);
	...
	var Round = function () {
	  ...
	  _createClass(Round, [{
	    ...
	    value: function startRound() {
	      ...
	      this.numberLine = new _number_line2.default(this.ctx);
	    ...
	    value: function animateFight() {
	      ...
	      if (this.containerNumber === 1) {
	        if (this.frameCount === 10) {
	          ...
	          this.frameCount += 1;
	          this.ctx.clearRect(0, 300, 810, 300);
	          this.characters.forEach(function (character, index) {
	  ...
	  _createClass(Character, [{
	    ...
	    value: function animateFight(container) {
	      ...
	      if (container.containerNumber === 1) {
	        if (this.xPos > 960) {
	          window.cancelAnimationFrame(requestID);
	          this.ctx.clearRect(860, 300, 280, 200);
	          var explosion = new _explosion2.default(this.ctx);
	          explosion.animateExplosion();
	        } else {
	          this.ctx.clearRect(this.xPos - 10, this.yPos, this.width + 30, this.height);
	          if (this.xPos < 810) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _explosionJSON = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thorJSON = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _juggernautJSON = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hulkJSON = __webpack_require__(22);
