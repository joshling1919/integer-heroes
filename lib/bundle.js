	...
	var Goblin = function (_Character) {
	  ...
	  _createClass(Goblin, [{
	    ...
	    value: function draw() {
	      ...
	      var goblin = _goblinJSON.GOBLIN6.frame;
	      this.image.onload = function () {
	        _this2.ctx.drawImage(_this2.image, goblin.x, goblin.y, goblin.w, goblin.h, _this2.xPos, _this2.yPos, _this2.width, _this2.height);
	      };
