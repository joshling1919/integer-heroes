	  ...
	  _createClass(Round, [{
	    ...
	    value: function clearCharacters() {
	      if (this.container1.selected) {
	        var charactersLength = this.container1.characters.length;
	        this.container1.characters.splice(0, charactersLength);
	        this.ctx.clearRect(152, 202, 596, 496);
	      } else if (this.container2.selected) {
	        var _charactersLength = this.container2.characters.length;
	        this.container2.characters.splice(0, _charactersLength);
	    ...
	    value: function checkNumberLine() {
	      ...
	      if (this.container1.value === this.numberLine.selected) {
	        ...
	        this.points -= 5;
	        instructions.innerHTML = "Hm, not quite, try again! Move the number line to represent the first number.";
	      }
	    }
	  }, {
	    key: 'checkAnswer',
	    ...
	    value: function secondStage() {
	      var instructions = document.getElementById('instructions');
	      instructions.innerHTML = "Nice job! Now, use the arrow keys to move the numberline to represent the first number, and then press 'Submit'!";
