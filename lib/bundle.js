	  ...
	  _createClass(Round, [{
	    ...
	    value: function checkForFighting() {
	      if (this.firstNum * this.secondNum < 0) {
	        this.instructions.innerHTML = "Cool! Now, use the arrow keys to move the number line to represent adding the second number!";
	        this.points.value += 5;
	        this.fightingStage();
	      } else {
	        this.points.value -= 5;
	    ...
	    value: function conclusion() {
	      key.unbind("right");
	      key.unbind("left");
	      var leftOver = this.container1.characters.length + this.container2.characters.length;
	    ...
	    value: function calculateLeftOver() {
	      // const firstContainerVal = this.container1.characters.length * this.cont
	      // this.container1.characters.length + this.container2.characters.length;
	      //need to check for 0. otherwise just multiply length by value of number at
	      //first index
	    }
	  }, {
	    key: 'wrongDirection',
