...
/***/ function(module, exports, __webpack_require__) {
	...
	var Character = function () {
	  function Character(ctx) {
	    ...
	    //probably will refactor parent character class to have
	    //the xPos and yPos of characters
	    this.ctx = ctx;
	  ...
	  _createClass(Character, [{
	    ...
	    value: function draw() {
	      ...
	      this.image.onload = function () {
	        _this.ctx.drawImage(_this.image, iron.x, iron.y, iron.w, iron.h, 0, 0, iron.w / 1.5, iron.h / 1.5);
	      };
	    }
	  }]);
