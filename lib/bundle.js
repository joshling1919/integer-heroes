...
/***/ function(module, exports, __webpack_require__) {
	...
	var Round = function () {
	  function Round(ctx) {
	    ...
	    this.ironmanStart = new _ironman_character2.default(ctx, 0, 0);
	    this.ironmanStart.draw();
	    this.instructions = "Click on the correct characters that represent the first number";
	    this.stage = 1;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ironman = function (_Character) {
	  ...
	  function Ironman(ctx, xPos, yPos) {
	    var _ref;
	
	    _classCallCheck(this, Ironman);
	
	    var _this = _possibleConstructorReturn(this, (_ref = Ironman.__proto__ || Object.getPrototypeOf(Ironman)).call.apply(_ref, [this].concat([xPos, yPos])));
