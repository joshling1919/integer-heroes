...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadedImages = 0;
	var imageArray = new Array("./lib/images/ironman_right.png", "./lib/images/ironman_left.png", "./lib/images/goblin_right.png", "./lib/images/goblin_left.png", "./lib/images/explosion.png");
	var imageObjArray = [];
	...
	var Round = function () {
	  ...
	  _createClass(Round, [{
	    ...
	    value: function secondStage() {
	      ...
	      //   round.instructions.innerHTML = "Now, use the arrow keys to move the numberline to represent the first number, and then press 'Submit'!";
	      // }, 1200);
	    ...
	    value: function thirdStage() {
	      ...
	      // let round = this;
	      // window.setTimeout( () => {
	      //   round.instructions.innerHTML = "Next, choose the correct characters to represent the second number!";
	      //   round.instructions.style.background = "#575757";
	      // }, 1200);
