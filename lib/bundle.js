...
/***/ function(module, exports, __webpack_require__) {
	...
	var Round = function () {
	  function Round(ctx) {
	    ...
	    this.container1 = new _container2.default(firstNum, ctx, true, 1);
	    this.container2 = new _container2.default(secondNum, ctx, false, 2);
	    this.ironmanStart = new _ironman_character2.default(1, ctx, 0, 0, this.container1, this.container2);
	...
	var Integer = function () {
	  ...
	  _createClass(Integer, [{
	    ...
	    value: function shrinkAndGrow() {
	      ...
	      this.ctx.clearRect(this.xPos - 50, this.yPos - 85, 100, 105);
	  ...
	  _createClass(Character, [{
	    ...
	    value: function newCharacter() {
	      ...
	      if (this.constructor.name === "Ironman") {
	        newCharacter = new _ironman_character2.default(1, this.ctx, undefined, undefined, this.container1, this.container2);
	      }
	      return newCharacter;
	    }
	  }, {
	...
	var Container = function () {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function submitAnswer() {
	      ...
	      return sameSign && sum === this.value;
	    }
	  }]);
