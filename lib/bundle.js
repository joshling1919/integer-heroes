	...
	var Round = function () {
	  ...
	  _createClass(Round, [{
	    ...
	    value: function fourthStage() {
	      ...
	      var firstButton = document.getElementById('submit');
	      var secondButton = document.getElementById('clear');
	      firstButton.innerHTML = "FIGHT";
	      secondButton.innerHTML = "JOIN FORCES";
