	    ...
	    value: function checkNumberLine() {
	      ...
	      if (this.container1.value === this.numberLine.selected) {
	        ...
	        understood.onclick = function () {
	          _this.instructions.innerHTML = "Now, use the arrow keys to move the numberline to represent the first number, and then press 'Submit'!";
