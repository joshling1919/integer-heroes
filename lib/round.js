...
class Round {
  constructor(ctx, points) {
    ...
    this.mathProblem = new MathProblem(ctx, this.firstNum, this.secondNum);
    this.container1 = new Container(this.firstNum, ctx, true, 1);
    this.container2 = new Container(this.secondNum, ctx, false, 2);
  ...
  conclusion(){
    key.unbind("right");
    key.unbind("left");
    let leftOver = this.container1.characters.length + this.container2.characters.length;
